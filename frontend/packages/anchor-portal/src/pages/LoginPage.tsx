      ...
      <div className="flex-1 flex items-center justify-center p-4">
        <div className="w-full max-w-sm">
          <PortalLoginBrandHeader
            portalSubtitle="Anchor Portal"
            strapline="Employee & salary management"
          />
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div>
                ...
                <input type="email" value={email} onChange={(e) => setEmail(e.target.value)}
                  className="w-full px-3.5 py-2.5 bg-slate-50 border border-slate-200 rounded-lg text-sm focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 focus:bg-white outline-none"
                  required />
              </div>
              <div>
